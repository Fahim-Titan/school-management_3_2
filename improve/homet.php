...
//echo $fetch['TEST'];
 echo '<table   style="width:100%"><tr><th width="130">';?><img src="<?php echo $image['location']; ?>" width="130" height="130"  id="images"/><?php echo '</th><th colspan="3" align="center"><p>Motijheel Model High School </p>
      <p>P.O BOX 1000, Dha </p>
...
<tr>
  ...
  <tr>
    <td colspan="5"><p>&nbsp;</p>
      ...
      <center>Motijheel Model High School </center>
      </p></td>
...
<div id="school_footer">
            <div align=center>
            <br>
            <br> Copyright &copy;  2015 Motijheel Model High School. Designed by Al Masum Fahim </div>
