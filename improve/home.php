...
<title>Welcome to Motijheel Model High School</title>
...
<div id="school_body_wrapper">
  <div id="school_wrapper">
    <div id="school_header">
      <div id="site_title"> Motijheel Model High School </div>
      <!-- end of site_title -->
	  ...
	  <br/></br>
        ...
        <div id="slider-wrapper">
          <div id="slider" class="nivoSlider">
           <img src='slider/bg1.jpg' alt="image" width="680" title="photo 1"  /> <a href="#">
           <img src="slider/bg2.jpg" alt="" width="680" title="photo 2" /></a> 
           <img src="slider/bg3.jpg" alt="image" width="680" title="photo 3" /> 
           <img src="slider/bg4.jpg" alt="image" width="680" title="photo 4" /> 
           <img src="slider/bg5.jpg" alt="image" width="680" title="photo 5" title="##htmlcaption"   /> 
           <img src="slider/bg6.jpg" alt="image" width="680" title="photo 6" /> 
           <img src="slider/bg7.jpg" alt="image" width="680" title="photo 7" /> 
           <img src="slider/bg1.jpg" alt="image" width="680" title="photo 1"  /> 
         </div>
        ...
        <p>&nbsp;</p>
        <h1>Motijheel Model High School</h1>
     LITERATURE HERE
...
?>
          <table style="border: 3px double #FF6600; background:url(../images/powder.gif);background-size:cover; padding:12px; color:#003366">
            <tr>
              <td scope="col" colspan="3" align="center">Motijheel Model High School </td>
            </tr>
            <tr>
              <td colspan="3">&nbsp;</td>
            </tr>
...
<div id="school_footer">
          <div align=center> Copyright &copy; 2015 Motijheel Model High School. Designed by Al Masum Fahim </div>
